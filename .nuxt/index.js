...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"UPLB | SRPVS","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Fuplbicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_vspagination_6c72be18 === 'function') {
    await nuxt_plugin_vspagination_6c72be18(app.context, inject)
  }
