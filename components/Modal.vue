  ...
  <div v-if="isOpen"  class="relative z-10 transition-opacity" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      ...
      <div class="fixed z-10 inset-0 overflow-y-auto">
        <div class="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
          ...
          -->
          <div class="relative border-8 border-solid border-green-800 rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
            <div class="w-full border-green-800 h-11 bg-green-800"></div>
